...
SECRET_KEY = 'yoff&96b5w%*_%r6ui5_dj)dss*ezoueh4^$z_@*jx6-=8xxf+'
...
INSTALLED_APPS = [
    ...
    'suppliersapp.apps.SuppliersappConfig',
    'productsapp.apps.ProductsappConfig',
    'ordersapp.apps.OrdersappConfig',
    'dbdataapp.apps.DbdataappConfig',
    'infoserviceapp.apps.InfoserviceappConfig',
